...
> Re-graded at each stream's close. **Last update: 2026-05-28 — legacy KEK retirement (cooldown); monolith data DEK re-wrapped off `LEGACY-V0` onto the current KEK.**
>
